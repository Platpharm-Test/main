...
export const PRODUCTS: Product[] = [
  ...
  { id: 21, code: 'YUH-021', name: '아세트아미노펜 시럽', supplier: '유한양행', drugClass: '일반', category: '해열진통소염제', form: '시럽', spec: '160ml', unitPrice: 2200, packSize: 1, packLabel: '1병', moq: 5, stock: '충분', stockCount: 156, image: '/package.png' },
  ...
  // 종근당
  { id: 9, code: 'JOO-009', name: '센트룸 멀티비타민', supplier: '종근당', drugClass: '일반', category: '비타민·영양제', form: '정', spec: '60정', unitPrice: 380, packSize: 60, packLabel: '1통 (60정)', moq: 2, stock: '보통', stockCount: 142, image: '/pill.png', recentOrdered: true },
  { id: 19, code: 'JOO-019', name: '오메가3 1200', supplier: '종근당', drugClass: '일반', category: '비타민·영양제', form: '캡슐', spec: '1200mg × 60캡슐', unitPrice: 980, packSize: 60, packLabel: '1통 (60캡슐)', moq: 2, stock: '충분', stockCount: 268, image: '/package.png' },
  ...
  { id: 34, code: 'JOO-034', name: '종근당 비타민C 1000', supplier: '종근당', drugClass: '일반', category: '비타민·영양제', form: '정', spec: '1000mg × 90정', unitPrice: 580, packSize: 90, packLabel: '1통 (90정)', moq: 2, stock: '보통', stockCount: 132, image: '/pill.png' },
  // 삼진제약
